...
- 🔭 Building data pipelines and AI agent infrastructure at **FH Data**
- 📚 Teaching assistant for Database Systems and Introduction to Programming at CIn – UFPE
- 🌱 Deepening Cloud (AWS/Azure), Kubernetes, and Infrastructure as Code
- 👥 Experienced leading technical teams and driving data strategy
- 💬 Ask me about data pipelines, cloud architecture, or AI agent orchestration
...
![Google Cloud Monitoring](https://img.shields.io/badge/Cloud_Monitoring-4285F4?style=flat-square&logo=googlecloud&logoColor=white)
...
| [**Sales Data Analysis**](https://github.com/jpbezerra/Analise-Vendas-PTA) | Exploratory data analysis and Power BI dashboard for a retail sales challenge | Python, Power BI |
...
**English** · [🇺🇸 back to top](#hi-im-joão-pedro-)
...
- 🔭 Construindo pipelines de dados e infraestrutura de agentes de IA na **FH Data**
- 📚 Monitor de Banco de Dados e Introdução à Programação no CIn – UFPE
- 🌱 Aprofundando Cloud (AWS/Azure), Kubernetes e Infraestrutura como Código
- 👥 Experiência liderando times técnicos e conduzindo estratégia de dados
- 💬 Pode me perguntar sobre pipelines de dados, arquitetura cloud ou orquestração de agentes de IA
...
| [**Análise de Dados de Vendas**](https://github.com/jpbezerra/Analise-Vendas-PTA) | Análise exploratória e dashboard em Power BI para desafio de vendas do varejo | Python, Power BI |
